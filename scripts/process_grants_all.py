...
combined_la.to_csv(os.path.join('src','_data','arts_council','all_summary_hex.csv'),index=False)
...
combined_region.to_csv(os.path.join('src','_data','arts_council','all_summary_region.csv'))
...
print(out_region)
with open(os.path.join('src','_data','arts_council','region_map.yaml'),'w') as f:
...
print(stats)
with open(os.path.join('src','_data','arts_council','stats.yaml'),'w') as f:
